...
make test         # Run all tests (12 packages, ~370)
...
- `rpc/` — JSON-RPC server, 72 methods (68/78 Core coverage + getnodestatus + 3 drivechain views), HTTP server
